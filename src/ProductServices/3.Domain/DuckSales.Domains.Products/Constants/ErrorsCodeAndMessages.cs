...
public static class ErrorMessages
{
    ...
    public static readonly string DepartmentNameWithInvalidSize = $"The department name must have at least {Departament.MinNameSize} and no more then {Departament.MaxNameSize} chars";
